...
/**
 * Implements CIOINA_StringType interface using the "ctype" extension.
...
require_once 'libraries/StringAbstractType.class.acioina.php';
 ...
 * @subpackage CType
 */
class CIOINA_StringCType extends CIOINA_StringAbstractType
{
    /**
