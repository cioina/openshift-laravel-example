<?php
/**
 * Specialized string class for ACIOINA.
...
require_once 'libraries/StringByte.int.acioina.php';
/**
 * Specialized string class for ACIOINA.
 * The SQL Parser code relies heavily on these functions.
 *
 * @package ACIOINA-String
 */
class CIOINA_String implements CIOINA_StringType
{
    /**
     * @var CIOINA_StringType
     */
    private $_type;
    ...
    public function __construct()
    {
        if (@extension_loaded('ctype')) {
            include_once 'libraries/StringCType.class.acioina.php';
            $this->_type = new CIOINA_StringCType();
        } else {
            include_once 'libraries/StringNativeType.class.acioina.php';
            $this->_type = new CIOINA_StringNativeType();
        }
    }
