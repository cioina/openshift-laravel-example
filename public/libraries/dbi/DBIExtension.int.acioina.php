<?php
/**
 * Contract for every database extension supported by ACIOINA
 *
 * @package ACIOINA-DBI
 */
if (! defined('ACIOINA')) {
 ...
 * @package ACIOINA-DBI
 */
interface CIOINA_DBI_Extension
{
    /**
...
/**
 * Defines CIOINA_MYSQL_CLIENT_API if it does not exist based
 ...
 * @return void
 */
function CIOINA_defineClientAPI($version)
{
    if (! defined('CIOINA_MYSQL_CLIENT_API')) {
        $client_api = explode('.', $version);
        define(
            'CIOINA_MYSQL_CLIENT_API',
            (int)sprintf(
                '%d%02d%02d',
