...
require_once './libraries/dbi/DBIExtension.int.acioina.php';

/**
 * MySQL client API
 */
CIOINA_defineClientAPI(mysqli_get_client_info(null));
...
/**
 * @see http://bugs.acioina.php.net/36007
 */
 ...
 */
$CIOINA_mysqli_flag_names = array(
    MYSQLI_NUM_FLAG => 'num',
 ...
 * @subpackage MySQLi
 */
class CIOINA_DBI_Mysqli implements CIOINA_DBI_Extension
{
    /**
    ...
    public function connect(
        ...
        $server_port = $GLOBALS['CIOINA_dbi']->getServerPort($server);
    ...
    {
        if ($options == ($options | CIOINA_DatabaseInterface::QUERY_STORE)) {
            $method = MYSQLI_STORE_RESULT;
        } elseif ($options == ($options | CIOINA_DatabaseInterface::QUERY_UNBUFFERED)) {
    ...
    {
        return mysqli_get_client_info(null);
    }
    ...
    public function getError($link)
    {
        ...
        return $GLOBALS['CIOINA_dbi']->formatError($error_number, $error_message);
    }
    ...
    public function getFieldsMeta($result)
    {
        ...
        // https://sourceforge.net/p/ACIOINA/bugs/2205/
    ...
    public function fieldFlags($result, $i)
    {
        ...
        $f = $f->flags;
        $flags = array();
        foreach ($GLOBALS['CIOINA_mysqli_flag_names'] as $flag => $name) {
            if ($f & $flag) {
                $flags[] = $name;
            }
        }
