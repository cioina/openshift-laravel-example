<?php
// General
$moxieManagerConfig['general.license'] = '376A-5A78-A107-4A87-900E-9542-E34C-9906';
...
$moxieManagerConfig['general.temp_dir'] = $GLOBALS['CIOINA_Config']->get('MoxieManagerBaseDir') . DIRECTORY_SEPARATOR .'filemanagersys'. DIRECTORY_SEPARATOR .'temp';
$moxieManagerConfig['general.http_proxy'] = '';
$moxieManagerConfig['general.allow_override'] = 'hidden_tools,disabled_tools';

// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $GLOBALS['CIOINA_Config']->get('MoxieManagerBaseDir') . DIRECTORY_SEPARATOR . 'filemanager';
$moxieManagerConfig['filesystem.include_directory_pattern'] = '/([A-z\d-\/_\s]+)?/';
$moxieManagerConfig['filesystem.exclude_directory_pattern'] = '/^mcith$/i';
$moxieManagerConfig['filesystem.include_file_pattern'] = '/([A-z\d-\/_.\s]+)?/';
$moxieManagerConfig['filesystem.exclude_file_pattern'] = '';
$moxieManagerConfig['filesystem.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['filesystem.allow_override'] = 'csv,xls,xlsx';
...
// Upload
$moxieManagerConfig['upload.include_file_pattern'] = '/([A-z\d-\/_.\s]+)?/';
$moxieManagerConfig['upload.exclude_file_pattern'] = '';
$moxieManagerConfig['upload.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['delete.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['rename.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['edit.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['view.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['download.extensions'] = 'csv,xls,xlsx';
...
$moxieManagerConfig['authenticator.login_page'] = $GLOBALS['CIOINA_Config']->get('MyBlogUrl'); //See class MOXMAN_Core_UploadHandler

// SessionAuthenticator
$moxieManagerConfig['SessionAuthenticator.logged_in_key'] = 'isLoggedIn';//See setIsLoggedIn() from Distilleries\Expendable\Helpers\UserUtils
$moxieManagerConfig['SessionAuthenticator.user_key'] = 'user';
$moxieManagerConfig['SessionAuthenticator.config_prefix'] = 'filemanager';
...
// Local filesystem
$moxieManagerConfig['filesystem.local.wwwroot'] = $GLOBALS['CIOINA_Config']->get('MoxieManagerBaseDir');
...
$moxieManagerConfig['log.path'] = $GLOBALS['CIOINA_Config']->get('MoxieManagerBaseDir') . DIRECTORY_SEPARATOR .'filemanagersys'. DIRECTORY_SEPARATOR .'logs';
...
$moxieManagerConfig['storage.path'] = $GLOBALS['CIOINA_Config']->get('MoxieManagerBaseDir') . DIRECTORY_SEPARATOR .'filemanagersys'. DIRECTORY_SEPARATOR .'jsonstorage';
