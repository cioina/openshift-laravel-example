...
class Form
{
    ...
    {
        if ( Arr::get($this->formOptions, 'model')) {
            $this->setModel(Arr::pull($this->formOptions, 'model'));
        }
    }
    ...
    {
        if ( Arr::get($this->formOptions, 'data')) {
            $this->addData(Arr::pull($this->formOptions, 'data'));
        }
    }
