<?php namespace Distilleries\DatatableBuilder;
      ...
      abstract class EloquentDatatable 
      {
          ...
          public function applyFilters()
          {
              ...
              {
                  if (in_array($name, $columns) && !empty($input))
                  {
          ...
          public function generateColomns($isSearchAndSort = true)
          {
              $this->applyFilters();
              ...
              $mergedArray = array_merge($colSearchAndSort, $sortOnly);
              $datatable->orderColumns($mergedArray);

              if($isSearchAndSort)
              {
                  $datatable->searchColumns($colSearchAndSort);
              }else{
                  $datatable->searchColumns($mergedArray);
              }
          ...
          public function addDefaultAction($template = 'datatable-builder::form.components.datatable.actions', $route = '')
          {
              ...
              trans('datatable-builder::datatable.actions'));
          }
