<?php namespace Distilleries\Expendable\Datatables\EmailType;

      use Distilleries\Expendable\Datatables\BaseDatatable;
      use Illuminate\Support\Facades\Request;

      class EmailTypeDatatable extends BaseDatatable 
      {
          public function build()
          {
              ...
              $this->add('email_type_id', null, trans('expendable::datatable.email_type_id'));
              $this->add('email_type_name', null, trans('expendable::datatable.email_type_name'));
